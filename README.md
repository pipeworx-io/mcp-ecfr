...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/search_regulations \
  -H 'Content-Type: application/json' \
  -d '{"query":"drone operation"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/search_regulations`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
